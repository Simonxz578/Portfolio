...
export const projects: CaseStudy[] = [
  {
    ...
    summary: "A bilingual 30-second visual pause for cognitively overloaded moments. Optional voice is transcribed by Whisper, structured by GLM and mapped into rain-to-clear, meteors or an unchanged sky.",
    ...
    constraints: ["First value must require no personal information", "The core loop needs no account; runtime AI runs only after explicit voice input"],
    role: "Independent Product Designer and Product Owner across strategy, research, interaction design, AI workflow and assisted delivery.",
    decisions: ["Put the 30-second pause before personalisation", "Constrain voice affect to environment parameters rather than a chat reply", "Store reflective state locally in the browser"],
    ...
    evaluation: ["10+ early user-feedback inputs informed five major product iterations.", "Negative, positive, neutral and service-failure scenarios verified environment mapping and safe fallback."],
    outcomes: ["Public bilingual beta deployed on Cloudflare."],
    limitations: ["Qualitative testing continues; no product-market-fit claim is made.", "Voice affect is not a psychological diagnosis; product analytics do not retain audio or transcripts."],
    learning: "The most important iteration removed setup before first value; the latest constrained AI to the emotion-structuring task where it adds value.",
    capabilities: ["Product Strategy", "User Research", "Interaction Design", "Whisper / GLM", "AI Safety Boundaries", "Local-first", "Bilingual"],
